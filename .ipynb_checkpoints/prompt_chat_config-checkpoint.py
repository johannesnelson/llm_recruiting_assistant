...
def prepare_template_string():
    ...
    by the triple backticks below. And format instructions for your response will be provided. 
    
    ``` 
    Job description: {job_description}, Desired education level: {desired_education}, Desired experience/skills: {desired_experience}
    ```
    {format_instructions}
    """
...
def prepare_chat_schemas():
    ...
    response_schemas = [relevant_experience, 
                        relevant_skills,
                        relevant_education,
                        candidate_score,
                        score_justification]
